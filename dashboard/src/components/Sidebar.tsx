...
import { IconOverview, IconSessions, IconModels, IconActivity, IconBarChart, IconBell, IconHeart, IconTag, IconHelpCircle, IconFileText, IconRefreshCw } from './Icons';
    ...
    <>
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <button
            className={`nav-item nav-item--help${page === 'changelog' ? ' active' : ''}`}
            onClick={() => onNavigate('changelog')}
          >
            <span className="nav-icon"><IconFileText size={16} /></span>
            <span>Changelog</span>
          </button>
